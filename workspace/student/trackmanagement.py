...
class Track:
    ...
    def __init__(self, meas, id):
        ...
        z_homog = np.ones((4,1))
        z_homog[0:3] = meas.z
        z_veh = meas.sensor.sens_to_veh * z_homog
        self.x = np.zeros((6,1))
        ...
        self.score = 1.0 / np.single(params.window)
...
class Trackmanagement:
    ...
    def manage_tracks(self, unassigned_tracks, unassigned_meas, meas_list):  
        ...
        for i in unassigned_tracks:
            ...
            if meas_list: # if not empty
                if meas_list[0].sensor.in_fov(track.x):
                    # your code goes here
                    # si sigue siendo visible decreser el track score 
                    # print("I am unassigned!")
                    track.score -= 1.0 / np.single(params.window)
                    if track.score <= 0:
                        track.score = 0
        ...
        # aqui esta inicializando nuevos tracks the measurements no asignados!
    ...
    def handle_updated_track(self, track):      
        ...
        if track.score >= 2.0 / np.single(params.window):
